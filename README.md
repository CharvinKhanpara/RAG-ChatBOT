...
Give this a try. The project is deployed upon **Hugging Face Spaces** using **Docker**. [Click to try it](https://huggingface.co/spaces/charvin04/RAG-ChatBOT)
...
1. Clone the repo
    ...
    ```bash
    git clone https://github.com/CharvinKhanpara/RAG-ChatBOT
    ```
